...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <script>
    $("input[name=wr_name]").focusout(()=> {
        set_cookie("wr_name", $("input[name=wr_name]").attr("value"), 86400);
    });
    if (get_cookie("wr_name")) {
        $("input[name=wr_name]").attr("value", get_cookie("wr_name"));
    }
    
    $("input[name=wr_password]").focusout(()=> {
        set_cookie("wr_password", $("input[name=wr_password]").attr("value"), 86400);
    });
    if (get_cookie("wr_password")) {
        $("input[password=wr_password]").attr("value", get_cookie("wr_password"));
    }
</script>
